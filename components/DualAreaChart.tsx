...
export default function DualAreaChart({ data, unit = "€", primaryProperty, secondaryProperty, primaryPropName, secondaryPropName, primaryPropColor = "#8884d8", secondaryPropColor = "#82ca9d" }: DualAreaChartProps) {
  return (
